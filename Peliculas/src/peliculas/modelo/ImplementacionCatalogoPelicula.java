...
public class ImplementacionCatalogoPelicula implements ICatalogoPeliculas{
    ...
    public void listarPelicula() {
        JOptionPane.showMessageDialog(null, this.listaPeliculas, "LISTA DE PELÍCULAS", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public void buscarPelicula(String nombrePelicula) {
        ...
        for (var pelicula : this.listaPeliculas) {
            if (nombrePelicula.equals(nombrePelicula)) {
                resultado = pelicula;
                break;
            } else {
                resultado = pelicula;
        ...
        if (nombrePelicula.equals(resultado)) {
            JOptionPane.showMessageDialog(null, "Resultado -> " + resultado, "BUSCAR PELICULA", JOptionPane.QUESTION_MESSAGE);
        }
